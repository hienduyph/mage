...
RUN pip3 install --no-cache-dir "mage-ai[bigquery,dbt,google-cloud-storage,mysql,postgres]==$VERSION" && cd /usr/local/lib/python3.10/site-packages && patch -p0 < /tmp/telegram.patch
